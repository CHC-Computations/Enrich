...
Original file is located at
    https://colab.research.google.com/drive/1FvJKqrAAWxkllQBPtZuASVhY0GtSUOvq
"""
...
data_bn = open_data("/content/drive/MyDrive/bn_data.json")
...
def get_closest_match(term, where):
  res = get_close_matches(term, where, 1, 0.86)
  return res
...
def identify_closest(row: str):

    result = [(k, data_bn[k]["subject_category"]) for k in data_bn.keys() if row == k]
    return result


ratio(data_bn["Kultura Nazca"]["150"], u'kultura nazca')
get_close_matches("barok", ["barok", "burak", "berek"], 3, 0.6)